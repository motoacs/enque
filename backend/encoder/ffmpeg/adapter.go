...
func (a *Adapter) Type() model.EncoderType { return model.EncoderTypeFFmpeg }

func (a *Adapter) BuildArgs(req encoder.BuildRequest) (encoder.BuildResult, error) {
	return encoder.BuildResult{}, &model.EnqueError{Code: model.ErrEncoderNotImplemented, Message: "ffmpeg adapter is not implemented in v1"}
}
...
func (a *Adapter) DetectCapabilities(ctx context.Context, encoderPath string) (map[string]any, error) {
	return nil, &model.EnqueError{Code: model.ErrEncoderNotImplemented, Message: "ffmpeg capabilities are not implemented in v1"}
}
